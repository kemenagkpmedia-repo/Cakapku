      ...
      <div className="space-y-4">
        {isLoading ? (
          <div className="p-20 flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-sm font-bold text-text-muted uppercase tracking-widest">Memuat Riwayat Kinerja...</p>
          </div>
        ) : records.length === 0 ? (
          <div className="p-20 text-center bg-white rounded-[2.5rem] border-2 border-dashed border-border flex flex-col items-center justify-center shadow-sm">
            ...
            <p className="text-sm text-text-muted mt-2 max-w-xs font-medium">Anda belum mencatatkan aktivitas kinerja apapun. Mulai hari ini dengan melaporkan progres kerja Anda.</p>
          </div>
        ) : (
                    ...
                    <div className="flex-1 space-y-5">
                      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                        <div className="space-y-1">
                          <h4 className="font-extrabold text-text-header text-[1.125rem] tracking-tight leading-snug">{record.uraian_pekerjaan}</h4>
                          <div className="flex items-center gap-2 mt-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-accent" />
                            <p className="text-[0.7rem] text-accent font-bold uppercase tracking-widest">
                              {record.perkin_name || record.iksk?.perkin?.nama_perkin || 'Perkin'}
                            </p>
                          </div>
